...
public class MyOrders2Adapter extends BaseQuickAdapter<MyOrderBean.UnfinishedBean,BaseViewHolder>{
    private Context mContext;
    private final static String URL="https://www.maiguanjy.com/";


    public MyOrders2Adapter(Context context, int layoutResId, @Nullable List<MyOrderBean.UnfinishedBean> data) {
    ...
    @Override
    protected void convert(@NonNull BaseViewHolder helper, MyOrderBean.UnfinishedBean item) {
