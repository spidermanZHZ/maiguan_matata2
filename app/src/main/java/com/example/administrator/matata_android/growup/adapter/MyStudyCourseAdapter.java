 ...
 * 学习中的课程适配器
 */
public class MyStudyCourseAdapter extends BaseQuickAdapter<MyCourseBean ,BaseViewHolder> {

    private Context mContext;
    private final static String URL="https://www.maiguanjy.com/";

    public MyStudyCourseAdapter(Context context, int layoutResId, @Nullable List<MyCourseBean> data) {
    ...
    @Override
    protected void convert(@NonNull BaseViewHolder helper, MyCourseBean item) {
        //加载图片
        //设置图片圆角角度
        ...
        if (item.getCard_type().equals("00")){
...
//            System.out.println(""+days+"天"+hours+"小时"+minutes+"分");
                helper.setText(R.id.music_adapter_tv_achievement,"已学习"+days+"天");
            }
            catch (Exception e)
            {
            }
