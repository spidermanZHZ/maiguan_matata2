 ...
 * 吸顶布局
 */
public class AllTeacherStickyLayoutHelperAdapter extends DelegateAdapter.Adapter<AllTeacherStickyLayoutHelperAdapter.StickyLayoutHelperViewHolder> {

    private Context mContext;
    private LayoutHelper mHelper;


    public AllTeacherStickyLayoutHelperAdapter(Context mContext, LayoutHelper mHelper) {
    ...
    public StickyLayoutHelperViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(mContext).inflate(R.layout.adapter_all_teacher_stick_layout,parent,false);
