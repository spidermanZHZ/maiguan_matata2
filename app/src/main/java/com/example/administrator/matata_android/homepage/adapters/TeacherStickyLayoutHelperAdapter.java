...
public class TeacherStickyLayoutHelperAdapter extends DelegateAdapter.Adapter<TeacherStickyLayoutHelperAdapter.StickyLayoutHelperTwoAdapterViewHolder> {

    private Context mContext;
    private LayoutHelper mHelper;

    public TeacherStickyLayoutHelperAdapter(Context mContext, LayoutHelper mHelper) {
    ...
    public void onBindViewHolder(@NonNull StickyLayoutHelperTwoAdapterViewHolder holder, int position) {
            ...
            holder.tv_course.setText("老师详情");
            holder.course_comment.setText("老师课程");
