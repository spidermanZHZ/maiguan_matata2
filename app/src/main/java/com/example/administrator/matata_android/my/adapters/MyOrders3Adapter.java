...
public class MyOrders3Adapter extends BaseQuickAdapter<MyOrderBean.FinishedBean,BaseViewHolder>{
    private Context mContext;
    private final static String URL="https://www.maiguanjy.com/";


    public MyOrders3Adapter(Context context, int layoutResId, @Nullable List<MyOrderBean.FinishedBean> data) {
    ...
    @Override
    protected void convert(@NonNull BaseViewHolder helper, MyOrderBean.FinishedBean item) {
